...
import { beforeEach, describe, specify } from "mocha"
    ...
    function () {
      ...
      describe("2.3.3.3.1: If/when `resolvePromise` is called with value `y`, run `[[Resolve]](promise, y)`", function () {
        ...
        describe("`y` is a thenable", function () {
          Object.keys(fulfilled).forEach(function (stringRepresentation) {
            function yFactory() {
          ...
          Object.keys(_rejected).forEach(function (stringRepresentation) {
            function yFactory() {
        ...
        describe("`y` is a thenable for a thenable", function () {
          Object.keys(fulfilled).forEach(function (outerStringRepresentation) {
            var outerThenableFactory = fulfilled[outerStringRepresentation]

            Object.keys(fulfilled).forEach(
              function (innerStringRepresentation) {
                var innerThenableFactory = fulfilled[innerStringRepresentation]
            ...
            Object.keys(_rejected).forEach(
              function (innerStringRepresentation) {
                var innerThenableFactory = _rejected[innerStringRepresentation]
